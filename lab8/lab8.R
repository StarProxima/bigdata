...
plot(years, VVP, xlab='Год', ylab='Прирост, %', main='Прирост ВВП Грузии', type='b', lty=1, pch=1,  lwd=2)
...
fit <- lm(Прирост_ВВП ~ Изменения_мед_расходов, data=states)
fit
...
par(mfrow=c(1, 2))
plot(states$`Изменения_мед_расходов`, states$`Прирост_ВВП`, xaxt="n", xlab="Изменения_мед_расходов", ylab="Прирост_ВВП", col="blue", main="Реальные значения")
abline(fit, col="red")
plot(pred, xaxt="n", xlab="Изменения_мед_расходов", ylab="Прирост_ВВП", col="blue", main="Прогноз")
